...
if [ $ups = ups.discovery ]; then
    ...
    case $key in
    ups.status)
        state=$(/bin/upsc $ups $key 2>&1 | grep -v SSL | awk '{print $1}')
        state_num
        exit
        ;;
    ups.status-2)
        state=$(/bin/upsc $ups ups.status 2>&1 | grep -v SSL | awk '{print $2}')
        state_num
        exit
        ;;
    ups.status-3)
        state=$(/bin/upsc $ups ups.status 2>&1 | grep -v SSL | awk '{print $3}')
        state_num
        exit
        ;;
    ups.status-4)
        state=$(/bin/upsc $ups ups.status 2>&1 | grep -v SSL | awk '{print $4}')
        state_num
        exit
        ;;
    ups.status-5)
        state=$(/bin/upsc $ups ups.status 2>&1 | grep -v SSL | awk '{print $5}')
        state_num
        exit
        ;;
    ups.alarm)
        alarm=$(/bin/upsc $ups ups.alarm 2>&1 | grep -v SSL | awk '{print $1}')
        alarm_num
        exit
        ;;
    ups.alarm-2)
        alarm=$(/bin/upsc $ups ups.alarm 2>&1 | grep -v SSL | awk '{print $2}')
        alarm_num
        exit
        ;;
    ups.alarm-3)
        alarm=$(/bin/upsc $ups ups.alarm 2>&1 | grep -v SSL | awk '{print $3}')
        alarm_num
        exit
        ;;
    ups.alarm-4)
        alarm=$(/bin/upsc $ups ups.alarm 2>&1 | grep -v SSL | awk '{print $4}')
        alarm_num
        exit
        ;;
    ups.alarm-5)
        alarm=$(/bin/upsc $ups ups.alarm 2>&1 | grep -v SSL | awk '{print $5}')
        alarm_num
        exit
        ;;
    ups.alarm-6)
        alarm=$(/bin/upsc $ups ups.alarm 2>&1 | grep -v SSL | awk '{print $6}')
        alarm_num
        exit
        ;;
    ups.alarm-7)
        alarm=$(/bin/upsc $ups ups.alarm 2>&1 | grep -v SSL | awk '{print $7}')
        alarm_num
        exit
        ;;
    ups.alarm-8)
        alarm=$(/bin/upsc $ups ups.alarm 2>&1 | grep -v SSL | awk '{print $8}')
        alarm_num
        exit
        ;;
    ups.alarm-9)
        alarm=$(/bin/upsc $ups ups.alarm 2>&1 | grep -v SSL | awk '{print $9}')
        alarm_num
        exit
        ;;
    ups.alarm-10)
        alarm=$(/bin/upsc $ups ups.alarm 2>&1 | grep -v SSL | awk '{print $10}')
        alarm_num
        exit
        ;;
    *)
        val=$(/bin/upsc $ups $key 2>&1 | grep -v SSL)
        other_val
        exit
        ;;
